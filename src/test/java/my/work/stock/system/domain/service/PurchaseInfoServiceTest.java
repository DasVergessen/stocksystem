...
@DatabaseSetup({"/data/computer_materials_category.xml", "/data/computer_materials_info.xml", "/data/supplier_info.xml", "/data/purchase_info.xml"})
public class PurchaseInfoServiceTest {
    ...
    public void testSearchSupplierInfo() throws Exception {
        ...
        Page<PurchaseInfo> purchaseInfos = purchaseInfoService.searchSupplierInfo(searchSupplierInfo);
